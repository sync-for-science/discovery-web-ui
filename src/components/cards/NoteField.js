...
const CompletedNote = ({noteText, editTimeStamp, handleDelete, handleEdit}) => {
...
const EditingNote = ({noteId, noteText, editTimeStamp, handleSave}) => {
...
const NoteField = ({noteId, noteText, editTimeStamp, isEditing, handleDelete, handleEdit, handleSave}) => {
  if (isEditing) {
    return (
      <EditingNote 
        noteId={noteId} 
