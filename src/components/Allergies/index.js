   ...
   render() {
      ...
      return ( this.state.matchingData &&
	       <div className={this.props.className}>
		     ...
		     <div className={this.props.isEnabled ? 'content-header' : 'content-header-disabled'}>Allergies</div>
	          </div>
	          <div className='content-body'>
		     { this.props.isEnabled && renderAllergies(this.state.matchingData, this.props.className) }
	          </div>
	       </div> );
   }
}
